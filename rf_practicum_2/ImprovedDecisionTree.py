...
class ImprovedDecisionTree(object):
    ...
    def fit(self, X, y, feature_names=None):
        ...
        def is_categorical(): return x, isinstance(x, (bool, str))
    ...
    def prune(self, X, y, node=None):
        ...
        # leaf_y equal to y/length of y (note that the leaf_y is a full
        # prediction on X!)

        # * now calculate the merged_score of which is
        # the number of merged_y values equal to y/length of y (note that these
        # are all one class!)
